      ...
      >
        <div style={{ maxWidth: '1000px' }}>
          <div className="section-badge" style={{ background: 'rgba(255, 255, 255, 0.15)', borderColor: 'rgba(255, 255, 255, 0.25)', color: 'var(--color-lime)', marginBottom: '1.8rem' }}>
            ...
            <span>INVESTIGACIÓN & DESARROLLO AITECH</span>
          </div>
          ...
          <h1 className="section-heading-xl" style={{ fontSize: 'max(2.8rem, min(5vw, 4.4rem))', color: '#ffffff', lineHeight: '1.12', marginBottom: '1.6rem' }}>
            {cienciaTecnologiaData.title}:{' '}
            <span style={{ color: 'var(--color-lime)' }}>La trinidad del conocimiento aplicado y la evolución continua.</span>
          </h1>

          <p style={{ fontSize: '1.25rem', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.92)', marginBottom: '2.5rem', maxWidth: '850px' }}>
            {cienciaTecnologiaData.subtitle}
          </p>

          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
            <span className="card-meta-badge lime-badge" style={{ padding: '7px 16px', fontSize: '0.8rem' }}>MÉTODO CIENTÍFICO</span>
            <span className="card-meta-badge dark-badge" style={{ padding: '7px 16px', fontSize: '0.8rem', background: 'rgba(255, 255, 255, 0.18)', color: '#ffffff' }}>INNOVACIÓN CONTINUA</span>
            <span className="card-meta-badge lime-badge" style={{ padding: '7px 16px', fontSize: '0.8rem' }}>IEEE STD 730</span>
            <span className="card-meta-badge dark-badge" style={{ padding: '7px 16px', fontSize: '0.8rem', background: 'rgba(255, 255, 255, 0.18)', color: '#ffffff' }}>SEI MARCOS DE CALIDAD</span>
          </div>
        </div>
      </section>
      ...
      <div style={{ paddingLeft: '4%', paddingRight: '4%' }}>
        ...
        <div style={{ marginBottom: '5rem' }}>
          <div className="section-badge">
            ...
            <span>PENSAMIENTO CIENTÍFICO Y TEÓRICO</span>
          </div>
            ...
            {cienciaTecnologiaData.quotes.map((quote, index) => (
              <div className="mv-card-interactive dark-theme" key={index}>
                <div className="card-meta">
                  <span className="card-meta-badge lime-badge">REFERENCIA ACADÉMICA</span>
        ...
        {/* Sección de Fundamento Teórico y Metodológico (3 Columnas Réplica) */}
        <div style={{ marginBottom: '5rem' }}>
          <div className="section-badge">
            <span className="badge-dot" />
            <span>FUNDAMENTACIÓN TEÓRICA Y METODOLÓGICA</span>
          </div>

          <h2 style={{ fontSize: '2.2rem', fontWeight: 400, marginBottom: '2.5rem', letterSpacing: '-0.02em', color: 'var(--color-charcoal)' }}>
            Ejes Fundamentales de Investigación y Tecnología
          </h2>
          ...
          <div className="tqm-three-column-grid">
            ...
            <div className="tqm-feature-card tqm-card-lime">
              ...
              <div className="tqm-card-body">
                <h3>{cienciaTecnologiaData.sections[0].heading}</h3>
                <p>{cienciaTecnologiaData.sections[0].content}</p>
              </div>
            </div>
            ...
            <div className="tqm-feature-card tqm-card-dark">
              ...
              <div className="tqm-card-body">
                <h3>{cienciaTecnologiaData.sections[1].heading}</h3>
                <p>{cienciaTecnologiaData.sections[1].content}</p>
              </div>
            </div>
            ...
            <div className="tqm-feature-card tqm-card-light">
              ...
              <div className="tqm-card-body">
                <h3>{cienciaTecnologiaData.sections[2].heading}</h3>
                <p>{cienciaTecnologiaData.sections[2].content}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="card-meta">
            <span className="card-meta-badge lime-badge">APLICACIÓN PRÁCTICA</span>
        ...
        <div style={{ marginBottom: '6rem' }}>
          <div className="section-badge">
            <span className="badge-dot" />
            <span>LITERATURA CIENTÍFICA Y ESTÁNDARES</span>
          </div>

          <h2 style={{ fontSize: '2.2rem', fontWeight: 400, marginBottom: '2.5rem', letterSpacing: '-0.02em', color: 'var(--color-charcoal)' }}>
            Publicaciones y Artículos de Referencia
          </h2>
                ...
                <div className={`cutout-card-wrapper ${currentTheme}`} key={index}>
                  ...
                  >
                    <div className="cutout-card-content">
                      <div className="card-meta">
                        <span className="card-meta-badge">PAPER {index + 1}</span>
